...
- Looking from the outside, neoliberalism model, developed by **The Chicago Boys** under Pinochet, appears to be successful
...
![GDP](/images/gdppc.PNG)
        ...
        ggplot(data = chl_data, aes(x = year, y = gdp.pc)) + geom_point() + geom_smooth(method = "lm")
...
![GDP](/images/gdpgini.PNG)
![GDP](/images/gdppalma.PNG)
![GDP](/images/gdppalma2.PNG)
...
###### Methods: 
The historical twitter data was loaded in R, and the packages ggplot2, wordcloud, and igraph will be used to analyze and visualize the data.
