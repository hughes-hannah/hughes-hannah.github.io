...
Exploratory data analysis to
  ...
  2. Develop time series model to analyze the relationship (if any) between copper prices and protest activity (in progress)
    a. Role of Fiscal Stabilizer: Given Chile’s reliance on natural resource (copper) exports, do commodity prices impact government spending on social programs?
    b. Does reduced government spending on social programs lead to an increase in protest activity?
